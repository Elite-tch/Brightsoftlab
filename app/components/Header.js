  ...
  return (
    <div>
      <div className="w-full  ">
        <nav className="text-[#1D1753] dark:text-gray-200 z-30 shadow-2xl w-full dark:shadow-lg fixed py-6 bg-white  dark:bg-custom-gradient ">
          <div className='flex justify-between items-center w-[90%] mx-auto'>
            <h2 className="text-3xl font-bold">JBTech<span className='text-[#f25c34]'> Solutions</span></h2>
        ...
        <div className={`fixed top-0 right-0 w-[70%] z-50 px-8 h-full bg-white dark:bg-custom-gradient shadow-lg transform ${isOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out`}>
